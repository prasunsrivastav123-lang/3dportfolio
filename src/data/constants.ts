...
export const SKILLS: Record<SkillNames, Skill> = {
  [SkillNames.JS]: {
    ...
    name: "js",
    label: "JavaScript",
    shortDescription: "yeeting code into the DOM since '2025, no cap! 💯🚀",
    color: "#f0db4f",
  ...
  [SkillNames.REACT]: {
    ...
    name: "react",
    label: "React",
    shortDescription: `"use using still learning new things" 
using use = useUsing("use")`,
  ...
  [SkillNames.EXPRESS]: {
    ...
    name: "express",
    label: "Express",
    shortDescription: "Still learning",
    color: "#fff",
  ...
  [SkillNames.NPM]: {
    ...
    name: "npm",
    label: "NPM",
    shortDescription: "still finding something 📦",
    color: "#fff",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Oryental Tech",
    description: [
      "Build a Online bike selling for chitransh auto sales",
      "Working with oryental for making website like dentals and others",
      "still finding some projects to work on, will update soon! ",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    description: [
      "working on a Bus project update will come soon",
      "still figuring out OWASP Bugs",
      "Preparing for gsoc 2026,will update the project details soon",
      "Still learning new things everyday, and trying to implement them in my projects, will update the project details soon",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
