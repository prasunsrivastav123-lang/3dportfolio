      ...
      return (
        <div>
          <TypographyP className="font-mono">
            ...
            projects, skills and immersive UI experiences.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <SlideShow images={[`${BASE_PATH}/portfolio/landing.png`, `${BASE_PATH}/portfolio/navbar.png`, `${BASE_PATH}/portfolio/project.png`, `${BASE_PATH}/portfolio/skills.png`]} />
        </div>
      );
    },
  },
  ...
  },
  {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            A MERN stack security platform that enables real-time reporting and tracking of local incidents using Socket.io. still in development phase.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <SlideShow
            images={[
